...
import com.example.tutorial4.model.FormData2
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spnSemester = findViewById(R.id.spnSemeter)
    ...
    override fun onResume() {
        ...
        btnSubmit.setOnClickListener(View.OnClickListener {
            ...
            val myForm = FormData2(edtStudentID.text.toString(),spnYear.selectedItem.toString(),
            ...
            val semesterValidation =  myForm.validateSemeter()
